...
urlpatterns = [
    ...
    path('homepage/<str:username>/', homepage, name='home_with_username'),  # Adjust the path based on your needs
    path('accounts/', include('django.contrib.auth.urls')),
    path('register/', RegisterView.as_view(), name='register'),
    path('accounts/profile/', login_required(profile), name='profile'),
    path('logout/', logout_view, name='logout'),  #logout option in main page for now
]
